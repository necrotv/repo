...
logourl      = base64.b64decode('aHR0cDovL25lY3JvdHYuZXN5LmVzL19ndWlkZS9sb2dvcy56aXA=')
...
try:
    if not os.path.exists(skinfolder):
        ...
        Url  = base64.b64decode('aHR0cDovL25lY3JvdHYuZXN5LmVzL19ndWlkZS9za2lucy56aXA=')
        LocalName = 'skins.zip'
...
try:
    Url  = base64.b64decode('aHR0cDovL25lY3JvdHYuZXN5LmVzL19ndWlkZS9hZGRvbnMuaW5p')
